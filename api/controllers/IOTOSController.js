...
module.exports = {
  ...
  get_config: asyncHandler(function (req, res) {
    
    //pi_list: id, ip, 
      //piresources: name, instance, inex, highlow, gpio
    
    var config_file = {};
    for (pi in pi_list) {
      config_file[pi] = { resources: {}, permissions: {}, publish_endpoints: {}};
      var ipcon = { ip: pi_list[pi].ip };
      config_file[pi]["resources"]["internal_IT"] = ipcon;
    }
